# 🛡️ Ultra-Modern Cyber-Tech SecOps Portfolio
...
* **Tailwind CSS (via CDN)** - Modern utility-first layout styling, text glow effects (`drop-shadow`), and glassmorphism styling (`backdrop-blur`).
* **Vanilla JavaScript** - Core logic handling the terminal typewriter engine, state management for the theme toggle, and particle loops.
...
```text
├── index.html        # Main production file containing layout, styling overrides, and scripts
